...
<form method="get" action="<%= ctx %>/Services/Cleaning/HouseKeeping.jsp">
  ...
  <h2 class="page-title">Post Renovation Cleaning</h2>
<p class="subtitle">Faster and Easier<br>for you to live comfortably in your new home</p>
