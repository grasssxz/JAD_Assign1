...
PreparedStatement ps = conn.prepareStatement(
    "SELECT booking_date FROM transport_booking WHERE id=? AND member_id=?"
);
...
<div class="max-w-xl mx-auto mt-12 bg-white p-6 rounded shadow">
    <h2 class="text-2xl font-bold mb-4">Reschedule Transport Booking</h2>

    <form action="TransportRescheduleSubmit.jsp" method="post" class="space-y-4">
        ...
        <div>
            ...
            <input type="date" name="new_date" required class="w-full p-2 border rounded">
        </div>
